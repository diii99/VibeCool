...
// Function to animate text as it scrolls into view
const animateTextElement = () => {
  ...
  .from(textElement, {
    ...
    ease: 'sine',
    yPercent: 300,                       // Move text from below the viewport
...
const animateCredits = () => {
  creditsTexts.forEach(creditsText => {
    ...
    .fromTo(creditsText, {
      x: 100,                             // Start with text offset to the right
    }, {
...
const init = () => {
  ...
  animateTextElement();   // Animate the text on scroll
...
function preloadAllImages() {
  // Using the imagesLoaded library directly
...
// Start the preload process when page is ready
